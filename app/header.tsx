        ...
        <>
            ...
            <header className={`sticky w-full grid grid-cols-[auto_1fr_auto${(account && account.token && isValidToken) ? '_auto' : ''}] p-4 h-24`}>
                ...
                {account && account.token && isValidToken
                    ...
                    : <Link href="/login/id">
                        <button className="p-3 mt-0 rounded-lg bg-blue-500 text-white hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-800 disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:hover:bg-gray-500 dark:disabled:hover:bg-gray-700 transition-all ease-in-out duration-200 focus:ring">
