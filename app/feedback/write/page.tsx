    ...
    return (
        <>
            <div className="border-b-slate-400 border-b">
                ...
                <label htmlFor="is_public" className="kor">{!isPublic && '비'}공개</label>
                <label htmlFor="is_public" className="eng">{!isPublic ? 'Private' : "Public"}</label>
                <br /><br />
            </div>
            <div>
                <br />
