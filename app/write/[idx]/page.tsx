...
export default function UpdatePost(props: { params: Promise<{ idx: string }> }) {
    ...
    return (<>
        <div className="border-b-slate-400 border-b">
            ...
            <br /><br />
            <label htmlFor="type" className="kor">유형: </label>
            <label htmlFor="type" className="eng">Type: </label>
